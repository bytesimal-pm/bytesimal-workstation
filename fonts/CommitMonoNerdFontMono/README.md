 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [CommitMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/CommitMono.zip)
   * [CommitMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/CommitMono.tar.xz) (smaller)
